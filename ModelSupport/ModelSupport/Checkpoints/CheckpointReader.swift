...
open class CheckpointReader {
    ...
    public init(checkpointLocation: URL, modelName: String, additionalFiles: [String] = []) throws {
        ...
        //print("CheckpointReader::init:    temporaryDirectory= \(temporaryDirectory.path)  checkpointLocation= \(checkpointLocation.path),  modelName= \(modelName) ")
        ...
        //print("CheckpointReader::init:    finalCheckpointLocation= \(finalCheckpointLocation.path) - \(finalCheckpointLocation.isFileURL) ")
        ...
        if finalCheckpointLocation.isFileURL {
            ...
            indexReader = try CheckpointIndexReader(file: finalCheckpointLocation.appendingPathExtension("index"))
        ...
        //print(self.metadata)
        //print("CheckpointReader::init - finish")
    }
    ...
    static func downloadCheckpointFiles(
        ...
        //print("CheckpointReader::downloadCheckpointFiles   checkpointLocation= \(checkpointLocation.path),  temporaryDirectory= \(temporaryDirectory.path) ")
