...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/FastStyleTransfer/FastStyleTransfer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModelSupport/ModelSupport.framework"
